...
import { pisoArriba } from "../PisoArriba/pisoArriba";
import { puertaPiso } from "../PuertaPiso/puertaPiso";
...
export const casaAmigo = () => {
  ...
  buttonElement.addEventListener("click", pisoArriba);
  ...
  buttonElement2.addEventListener("click", puertaPiso);
