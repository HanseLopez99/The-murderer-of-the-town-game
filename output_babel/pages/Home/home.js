...
var _aboutUs = require("../AboutUs/aboutUs");

var _contactUs = require("../ContactUs/contactUs");

var _instructions = require("../Instructions/instructions");

var _llegada = require("../Llegada/llegada");

var _Town = _interopRequireDefault(require("../../assets/images/Town.jpg"));
...
const home = () => {
  ...
  imgElement.setAttribute("src", _Town.default);
  ...
  buttonElement.addEventListener("click", _instructions.instructions);
  ...
  pElement2.innerHTML = "!!Trata de imaginar que en verdad estas en el juego!! Haz lo que har\xEDas tu normalmente.\n\n  No dejes que el miedo te afecte...";
  ...
  buttonElement2.addEventListener("click", _llegada.llegada);
  ...
  aboutUsTabElement.addEventListener("click", _aboutUs.aboutUs);
